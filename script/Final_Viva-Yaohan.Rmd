...
## 2017
mod1 <- lm(total_rider_tran ~ total_rider_bike, data = final_17_total_acs.dot)
summary(mod1)

## 2019
mod2 <- lm(total_rider_tran ~ total_rider_bike, data = final_19_total_acs.dot)
summary(mod2)
```
...
```{r step2}
## 2017
mod3 <- lm(total_rider_tran ~ .-tran_stop, data = final_17_total_acs.dot)
summary(mod3)

mod4 <- lm(total_rider_tran ~ .-tran_stop, data = final_17_total_acs.buffer)
summary(mod4)

## 2019
mod5 <- lm(total_rider_tran ~ .-tran_stop, data = final_19_total_acs.dot)
summary(mod5)
vif(mod5)

mod6 <- lm(total_rider_tran ~ .-tran_stop, data = final_19_total_acs.buffer)
summary(mod6)
```
