...
final_19_period_acs.dot <- final_19_period_bike %>%
...
final_19_total_acs.dot <- final_19_total_acs.dot %>%
  mutate(nearest_bike =
        nn_function(st_coordinates(tran_rider_19_total), st_coordinates(bike_rider_19_total),1))

## 2019

modb.1 <- lm(log(total_rider_tran) ~ log(total_rider_bike + 1)*time_period, data = final_19_period_acs.dot)
summary(modb.1)
vif(modb.1)
