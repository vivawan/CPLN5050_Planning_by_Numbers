...
```{r step3}
## 2019
mod.7 <- lm(log(total_rider_tran + 1) ~ log(total_rider_bike + 1) + time_period_cat + bus_stop + pop.den + commuter.tot + white.share + log(bike.share+1), data = final_19_period_acs)
summary(mod.7)
vif(mod.7)
```
...
```{r step4}
## 2019
mod.8 <- lm(log(total_rider_tran + 1) ~ log(total_rider_bike + 1)*time_period_cat + bus_stop + pop.den + commuter.tot + white.share + log(bike.share+1), data = final_19_period_acs)
summary(mod.8)
```
