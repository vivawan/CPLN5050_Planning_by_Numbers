...
## 2017
moda.0 <- lm(total_rider_tran ~ total_rider_bike, data = final_17_total_acs.dot)
summary(moda.0)
...
```{r step2}
## 2017
moda.1 <- lm(total_rider_tran ~ .-tran_stop, data = final_17_total_acs.dot)
summary(moda.1)

moda.2 <- lm(total_rider_tran ~ .-tran_stop, data = final_17_total_acs.buffer)
summary(moda.2)

## 2019
modb.1 <- lm(log(total_rider_tran) ~ bike, data = final_19_total_acs.dot)
summary(modb.1)
vif(modb.1)
...
modb.2 <- lm(total_rider_tran ~ .-tran_stop, data = final_19_total_acs.buffer)
summary(modb.2)
vif(modb.2)
```
